type InitMessageFromMain = { type: "init"; data: SharedArrayBuffer };
...
type StdinMessageFromWorker = { type: "stdin"; data?: undefined };
type StdoutMessageFromWorker = { type: "stdout"; data: number | null };
type StderrMessageFromWorker = { type: "stderr"; data: number | null };
export type Result = {
  exitCode: number;
  outputFiles: Record<string, Uint8Array<ArrayBuffer>>;
};
type CompleteMessageFromWorker = { type: "complete"; data: Result };

export type MessageFromMain = InitMessageFromMain | StartMessageFromMain;
export type MessageFromWorker =
  | ReadyMessageFromWorker
  | StdinMessageFromWorker
